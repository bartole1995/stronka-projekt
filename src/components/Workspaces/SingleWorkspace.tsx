...
export const SingleComponent: FC = () => {
    ...
    return (
        <SingleComponentWrapper>
            <Link to="/workspaces" className="linksForSites" onClick={() => { dispatch<SetWebsite>(setWebsite(["Client contract",path])) }}>
            ...
            <Link to="/workspaces" className="linksForSites" onClick={() => { dispatch<SetWebsite>(setWebsite(["Supplier Contract",path])) }}>
                <SingleComponentContent>
            ...
            <Link to="/workspaces" className="linksForSites" onClick={() => { dispatch<SetWebsite>(setWebsite(["Corporate",path])) }}>
                <SingleComponentContent>
            ...
            <Link to="/workspaces" className="linksForSites" onClick={() => { dispatch<SetWebsite>(setWebsite(["Group Norms",path])) }}>
                <SingleComponentContent>
            ...
            <Link to="/workspaces" className="linksForSites" onClick={() => { dispatch<SetWebsite>(setWebsite(["Real Rstate Contracts",path])) }}>
                <SingleComponentContent>
